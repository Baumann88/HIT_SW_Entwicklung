...
{
   stw_types::uint32 u32_Bitfield = 0u;
...
{
   stw_types::uint32 u32_BitPosMSB = 0u;
...
{
   stw_types::uint32 u32_Result = 0u;
...
{
   stw_types::uint32 u32_UInt32 = 0u;
...
{
   stw_types::uint32 u32_Diff = 0u;             // preset variable to prevent warning
...
*/
//-----------------------------------------------------------------------------
INLINE stw_types::uint32 data_diff_u32 (const stw_types::uint32 ou32_Data1, const stw_types::uint32 ou32_Data2)
{
...
INLINE void cache_writeback_invalidate(const volatile stw_types::uint8 * const opu8_Data, stw_types::uint32 ou32_Count)
{
...
INLINE void cache_invalidate(const volatile stw_types::uint8 * const opu8_Data, stw_types::uint32 ou32_Count)
{
