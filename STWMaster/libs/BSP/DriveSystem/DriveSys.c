...
void InitInterfaceDriveSys(void){
    ...
    inputMotor111ActualTorque=BindODMem(InverterStartIndex,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor111ActualTorque=0;
    inputMotor112ActualTorque=BindODMem(InverterStartIndex+0x0001,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor112ActualTorque=0;
    inputMotor121ActualTorque=BindODMem(InverterStartIndex+0x0002,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor121ActualTorque=0;
    inputMotor122ActualTorque=BindODMem(InverterStartIndex+0x0003,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor122ActualTorque=0;
    inputMotor211ActualTorque=BindODMem(InverterStartIndex+0x0004,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor211ActualTorque=0;
    inputMotor212ActualTorque=BindODMem(InverterStartIndex+0x0005,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor212ActualTorque=0;
    inputMotor221ActualTorque=BindODMem(InverterStartIndex+0x0006,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor221ActualTorque=0;
    inputMotor222ActualTorque=BindODMem(InverterStartIndex+0x0007,SubindexInverterTPDO1HighDWord,TypeS16,0); *inputMotor222ActualTorque=0;
    ...
    outputSetMotor111FeedForwardTorque=BindODMem(InverterStartIndex,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor111FeedForwardTorque=0;
    outputSetMotor112FeedForwardTorque=BindODMem(InverterStartIndex+0x0001,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor112FeedForwardTorque=0;
    outputSetMotor121FeedForwardTorque=BindODMem(InverterStartIndex+0x0002,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor121FeedForwardTorque=0;
    outputSetMotor122FeedForwardTorque=BindODMem(InverterStartIndex+0x0003,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor122FeedForwardTorque=0;
    outputSetMotor211FeedForwardTorque=BindODMem(InverterStartIndex+0x0004,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor211FeedForwardTorque=0;
    outputSetMotor212FeedForwardTorque=BindODMem(InverterStartIndex+0x0005,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor212FeedForwardTorque=0;
    outputSetMotor221FeedForwardTorque=BindODMem(InverterStartIndex+0x0006,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor221FeedForwardTorque=0;
    outputSetMotor222FeedForwardTorque=BindODMem(InverterStartIndex+0x0007,SubindexInverterRPDO1HighDWord,TypeS16,0); *outputSetMotor222FeedForwardTorque=0;
